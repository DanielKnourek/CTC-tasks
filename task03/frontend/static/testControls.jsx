...
const UpdateProduct = (props) => {
    const update = async () => {
        ...
        console.log(header);
        fetchAPI(`product/${props.ID}`, header)
            .then(response => {
                console.log(response);
                props.setText(JSON.stringify(response));
            })
...
function testControls(props) {
    ...
    return (
        <React.Fragment>
            ...
            <br />
            <InsertProduct Name={Name} Price={Price} Ammount={Ammount} setText={setResultAsText} />
            <br />
            <UpdateProduct ID={ID} Name={Name} Price={Price} Ammount={Ammount} setText={setResultAsText} />
            <br />
            <div>
                {ResultAsText}
            </div>
